...
const DEMO_ANIMALES = [
  { id: 'demo_animal_1', usuario_id: 'demo_1', nombre: 'Betsy', numero_identificacion: 'BOV-001', especie: 'Bovino', raza: 'Angus', fecha_nacimiento: '2022-03-15', sexo: 'H', estado: 'Excelente' },
  { id: 'demo_animal_2', usuario_id: 'demo_1', nombre: 'Torito', numero_identificacion: 'BOV-002', especie: 'Bovino', raza: 'Brahman', fecha_nacimiento: '2021-08-20', sexo: 'M', estado: 'Bueno' },
  { id: 'demo_animal_3', usuario_id: 'demo_1', nombre: 'Luna', numero_identificacion: 'BOV-003', especie: 'Bovino', raza: 'Gyr', fecha_nacimiento: '2023-01-10', sexo: 'H', estado: 'Excelente' },
  { id: 'demo_animal_4', usuario_id: 'demo_2', nombre: 'Carlos', numero_identificacion: 'BOV-101', especie: 'Bovino', raza: 'Charolais', fecha_nacimiento: '2020-05-12', sexo: 'M', estado: 'Excelente' },
  { id: 'demo_animal_5', usuario_id: 'demo_2', nombre: 'Blanca', numero_identificacion: 'BOV-102', especie: 'Bovino', raza: 'Charolais', fecha_nacimiento: '2022-11-08', sexo: 'H', estado: 'Bueno' },
  { id: 'demo_animal_6', usuario_id: 'demo_2', nombre: 'Bravo', numero_identificacion: 'BOV-103', especie: 'Bovino', raza: 'Simmental', fecha_nacimiento: '2021-07-22', sexo: 'M', estado: 'Excelente' },
  { id: 'demo_animal_7', usuario_id: 'demo_3', nombre: 'Manchita', numero_identificacion: 'BOV-201', especie: 'Bovino', raza: 'Brahman', fecha_nacimiento: '2022-04-18', sexo: 'H', estado: 'Bueno' },
  { id: 'demo_animal_8', usuario_id: 'demo_3', nombre: 'Gordo', numero_identificacion: 'BOV-202', especie: 'Bovino', raza: 'Gyr', fecha_nacimiento: '2020-12-05', sexo: 'M', estado: 'Excelente' },
  { id: 'demo_animal_9', usuario_id: 'demo_4', nombre: 'Ringo', numero_identificacion: 'BOV-301', especie: 'Bovino', raza: 'Hereford', fecha_nacimiento: '2021-09-30', sexo: 'M', estado: 'Excelente' },
  { id: 'demo_animal_10', usuario_id: 'demo_4', nombre: 'Dulce', numero_identificacion: 'BOV-302', especie: 'Bovino', raza: 'Angus', fecha_nacimiento: '2023-02-14', sexo: 'H', estado: 'Bueno' },
]
