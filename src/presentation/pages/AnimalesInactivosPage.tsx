...
function AnimalesInactivosContent() {
  ...
  const puedeReactivar = !user?.es_sesion_trabajador
              ...
              <div className="mb-8">
                ...
                {!puedeReactivar && (
                  <p className="text-amber-900 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 text-sm mt-3 max-w-xl">
                    Sesión de trabajador: puedes consultar el archivo; no puedes reactivar animales.
                  </p>
                )}
              </div>
                ...
                {animales.map((animal) => (
                  <div key={animal.id} className="bg-gray-50 border-2 border-gray-100 rounded-3xl p-6 shadow-md hover:shadow-xl transition-all">
                    ...
                    {puedeReactivar ? (
                      <button 
                        type="button"
                        onClick={() => animal.id && reactivarAnimal(animal.id)}
                      ...
                      <p className="w-full py-3 text-center text-xs text-gray-500 font-medium border border-dashed border-gray-200 rounded-xl">
