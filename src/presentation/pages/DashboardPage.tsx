  ...
  const loadData = async () => {
    ...
    try {
      ...
      setEstadisticas({
        ...
        animalesEnVenta: animales.filter((a: any) => a.en_venta && !a.vendido_a).length,
      ...
      const estadisticasAvanzadas = calcularEstadisticas.execute(animales, vacunaciones, pesos, capacidadMaxima)
