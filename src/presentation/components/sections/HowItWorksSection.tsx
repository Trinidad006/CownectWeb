...
const steps = [
  ...
  },
  {
    ...
    details: 'Una vez configurado, podrás gestionar todos los aspectos de tu ganadería desde un solo lugar. Registra vacunaciones, controla el peso de tus animales, lleva un historial médico completo El sistema te enviará alertas automáticas para vacunaciones pendientes y te proporcionará reportes detallados para tomar decisiones informadas.'
  }
]
